...
pub struct Settings {
    ...
    pub auto_follow_twitch: bool,
    pub auto_follow_twitter: bool,
    pub auto_retweet: bool,
    pub auto_tweet: bool,
    pub auto_tweet_share: bool,
    pub auto_email_subscribe: bool,
    pub display_dev_messages: bool,
    pub display_alpha_warning: bool,
...
impl std::default::Default for Settings {
    fn default() -> Settings {
        Settings {
            ...
            total_entries: 0,
            auto_follow_twitch: false,
            auto_follow_twitter: false,
            auto_retweet: false,
            auto_tweet: false,
            auto_tweet_share: false,
            auto_email_subscribe: false,
            display_dev_messages: false,
            display_alpha_warning: true,
